...
namespace Drupal\Tests\ai_vdb_provider_postgres\Unit;
...
final class PostgresProviderFilterQuotingTest extends UnitTestCase {
  ...
  public function testNumericFilterValueIsQuoted(string $value): void {
    ...
    $dataDefinition = $this->createMock(DataDefinitionInterface::class);
    $dataDefinition->method('isList')->willReturn(FALSE);
    $field->method('getDataDefinition')->willReturn($dataDefinition);
